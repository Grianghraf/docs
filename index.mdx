...
<Card title="View flows" icon="user" href="/api-flows/admin" horizontal>
See the paths for each user of the system.
</Card>
<Card
  title="API reference"   icon="square-code" href="/api-reference/endpoint" horizontal>
  See all available endpoints and operations for the API.
</Card>
<Card
  title="System architecture"   icon="diagram-project" href="/architecture/architecture" horizontal>
